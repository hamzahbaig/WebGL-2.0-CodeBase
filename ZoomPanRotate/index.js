...
const scene = [
  { x: 350, y: 60, rotation: 0, scale: 75, color: [1, 0, 0, 1], bufferInfo },
  {
    x: 500,
    y: 300,
    rotation: Math.PI,
  ...
  { x: 500, y: 300, rotation: 0, scale: 40, color: [0, 0, 1, 1], bufferInfo },
  { x: 200, y: 100, rotation: 0.7, scale: 25, color: [1, 0, 1, 1], bufferInfo },
];
...
function drawThing(thing) {
  ...
  // calls gl.uniformXXX
  m3.multiply(viewProjectionMat, mat);
